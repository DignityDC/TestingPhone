...
-- Main
Config.OpenKey = "m" -- open key (gta keybind)
...
Config.StartingDigits = "462" -- the starting digits for phone number (max 4) (example: 111234421) | default: "111"
...
Config.ImgBBProviderKey = "ec261eed9155794e4e22e887e7fe1177"
